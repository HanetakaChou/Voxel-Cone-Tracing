...
class Demo
{
	...
	ID3D11UnorderedAccessView *m_clipmap_texture_opacity_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_opacity_srv;
	ID3D11UnorderedAccessView *m_clipmap_texture_illumination_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_illumination_srv;
