...
class Demo
{
	...
	ID3D11UnorderedAccessView *m_clipmap_texture_opacity_r32_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_opacity_r32_srv;
	ID3D11UnorderedAccessView *m_clipmap_texture_opacity_r16_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_opacity_r16_srv;
	ID3D11UnorderedAccessView *m_clipmap_texture_illumination_r32_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_illumination_r32_srv;
	ID3D11UnorderedAccessView *m_clipmap_texture_illumination_g32_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_illumination_g32_srv;
	ID3D11UnorderedAccessView *m_clipmap_texture_illumination_b32_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_illumination_b32_srv;
	ID3D11UnorderedAccessView *m_clipmap_texture_illumination_r16g16b16_uav;
	ID3D11ShaderResourceView *m_clipmap_texture_illumination_r16g16b16_srv;
