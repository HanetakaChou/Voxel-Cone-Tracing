...
#define BRX_VCT_CLIPMAP_ILLUMINATION_TEXTURE_DIRECTION_COUNT 6
#define BRX_VCT_CLIPMAP_ILLUMINATION_TEXTURE_CHANNEL_COUNT 3
...
#if (BRX_VCT_CLIPMAP_ILLUMINATION_TEXTURE_DIRECTION_COUNT * BRX_VCT_CLIPMAP_ILLUMINATION_TEXTURE_CHANNEL_COUNT + BRX_VCT_CLIPMAP_STACK_LEVEL_COUNT) > 32
#error "mask 32 bit"
#endif
