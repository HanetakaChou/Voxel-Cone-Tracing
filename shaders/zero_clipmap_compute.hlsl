...
{
    return brx_read_write_texture_3d_uint_get_dimension(g_clipmap_texture_mask);
}
...
brx_int3 brx_vct_application_bridge_get_clipmap_opacity_dimension()
{
    ...
    return brx_write_only_texture_3d_uint_get_dimension(g_clipmap_texture_opacity);
}
...
{
    return brx_write_only_texture_3d_uint_get_dimension(g_clipmap_texture_illumination);
}
