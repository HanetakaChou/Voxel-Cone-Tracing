...
RWTexture3D<uint> g_clipmap_texture_mask : register(u0);
RWTexture3D<uint> g_clipmap_texture_opacity : register(u1);
RWTexture3D<uint> g_clipmap_texture_illumination_red : register(u2);
RWTexture3D<uint> g_clipmap_texture_illumination_green : register(u3);
RWTexture3D<uint> g_clipmap_texture_illumination_blue : register(u4);
