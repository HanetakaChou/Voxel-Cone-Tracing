...
{
    brx_int3 opacity_texture_dimension = brx_texture_3d_get_dimension(t_clipmap_texture_opacity, 0);

    brx_float3 normalized_opacity_texture_coordinates = in_opacity_texture_coordinates / brx_float3(opacity_texture_dimension);

    brx_float opacity = brx_sample_level_3d(t_clipmap_texture_opacity, s_sampler, normalized_opacity_texture_coordinates, 0).x;
...
{
    brx_int3 illumination_texture_dimension = brx_texture_3d_get_dimension(t_clipmap_texture_illumination, 0);
    ...
    brx_float3 illumination_channel = brx_sample_level_3d(t_clipmap_texture_illumination, s_sampler, normalized_illumination_texture_coordinates, 0).xyz;
