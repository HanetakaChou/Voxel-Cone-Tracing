...
brx_pixel_shader_parameter_end(main)
{
    ...
    brx_float3 radiance;
    {
        ...
        brx_branch if (NdotL > 0.0)
        {
            ...
            brx_branch if (brx_all(E_n > brx_float3(0.0, 0.0, 0.0)))
            {
                ...
                // brx_branch if (NdotV > 0.0)
                {
                    ...
                    brx_float3 specular_brdf;
                    {
                        ...
                        const brx_float cvar_global_min_surface_roughness_override = 0.02;
                        surface_roughness = brx_max(surface_roughness, cvar_global_min_surface_roughness_override);
