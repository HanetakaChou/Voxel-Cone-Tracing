...
brx_int brx_vct_application_bridge_get_incident_count(in brx_float3 in_surface_position_world_space)
{
    return 1;
}

brx_float3 brx_vct_application_bridge_get_incident_direction(in brx_int in_incident_index, in brx_float3 in_surface_position_world_space, in brx_float3 in_surface_shading_normal_world_space)
{
    return brx_normalize(g_light_direction);
}

brx_float3 brx_vct_application_bridge_get_incident_illumination(in brx_int in_incident_index, in brx_float3 in_surface_position_world_space, in brx_float3 in_surface_shading_normal_world_space)
{
    return g_light_color * get_shadow(in_surface_position_world_space);
}
